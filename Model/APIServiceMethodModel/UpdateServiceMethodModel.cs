...
{
    class UpdateServiceMethodModel : ClassMethodModel
    {
        public UpdateServiceMethodModel(bool IsForInterface) :
            base()
        {
            this.IsForInterface = IsForInterface;
        }

        public UpdateServiceMethodModel(string accessType, string returnType, string methodType, string methodName) : base(accessType, returnType, methodType, methodName)
        {
