...
{
    class GetServiceMethodModel : ClassMethodModel
    {
        public GetServiceMethodModel(bool IsForInterface) :
            base()
        {
            this.IsForInterface = IsForInterface;
        }

        public GetServiceMethodModel(string accessType, string returnType, string methodType, string methodName) : base(accessType, returnType, methodType, methodName)
        {
        ...
        public override ClassMethodModel Initialize()
        {
            ...
            this.ReturnType = "ResponseModel<" + TableName + "Model>";
            this.MethodType = null;
            this.MethodName = "Get" + TableName + "Data";
            ...
            sb.AppendLine("                " + TableName + "Model" + " value = " + TableName + "Dalobj." + this.MethodName + "(Data);");
