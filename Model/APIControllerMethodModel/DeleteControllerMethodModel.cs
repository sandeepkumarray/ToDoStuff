...
{
    class DeleteControllerMethodModel : ClassMethodModel
    {
        public DeleteControllerMethodModel() :
            base()
        {
        }

        public DeleteControllerMethodModel(string accessType, string returnType, string methodType, string methodName) :
