...
{
    class SaveControllerMethodModel : ClassMethodModel
    {
        public SaveControllerMethodModel() :
            base()
        {
        }

        public SaveControllerMethodModel(string accessType, string returnType, string methodType, string methodName) :
        ...
        public override ClassMethodModel Initialize()
        {
            ...
            sb.AppendLine("                responseModel = " + TableName + "Service." + this.MethodName + "(objPayLoad);");
