...
{
    class GetAllControllerMethodModel : ClassMethodModel
    {
        public GetAllControllerMethodModel() :
            base()
        {
        }

        public GetAllControllerMethodModel(string accessType, string returnType, string methodType, string methodName) :
        ...
        public override ClassMethodModel Initialize()
        {
            ...
            sb.AppendLine("");
            sb.AppendLine("            var responseModel = new ResponseModel<List<" + TableName + "Model >>()");
            sb.AppendLine("            {");
            ...
            sb.AppendLine("                responseModel = " + TableName + "Service." + this.MethodName + "(userId);");
