...
{
    class AddControllerMethodModel : ClassMethodModel
    {
        public AddControllerMethodModel() :
            base()
        {
        }

        public AddControllerMethodModel(string accessType, string returnType, string methodType, string methodName) :
